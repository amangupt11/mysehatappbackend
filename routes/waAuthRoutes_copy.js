// routes/waAuthRoutes.js - FIXED: Token rotation + proper expiry
 ...
 * ============================================================================
 */
router.post('/wa-auth/verify-login', async (req, res) => {
  try {
 ...
 * ============================================================================
 */
router.post('/wa-auth/refresh-token', async (req, res) => {
  try {
 ...
 * ============================================================================
 */
router.post('/wa-auth/logout', authenticateToken, async (req, res) => {
  try {
    return res.json({
      success: true,
 ...
 * ============================================================================
 */
router.post('/wa-auth/complete-profile', authenticateToken, async (req, res) => {
  try {
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
